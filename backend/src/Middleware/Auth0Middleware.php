...
class Auth0Middleware implements MiddlewareInterface
{
    ...
    public function process(Request $request, RequestHandlerInterface $handler): Response
    {
        ...
        try {
            ...
            // Add both Auth0 user info and Anime Prompt Generator user to request
        ...
        try {
            ...
            if (!$user) {
                ...
                $user = User::create([
                    ...
                    'display_name' => $auth0User->name ?? $auth0User->email ?? 'Artist',
                    'preferences' => [
                        'default_style' => 'anime',
            ...
            // Add computed fields for the middleware response
            $userData = $user->toArray();
            $userData['generation_stats'] = $user->getGenerationStats();
            $userData['generation_defaults'] = $user->getGenerationDefaults();
