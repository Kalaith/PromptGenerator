...
const MonsterGirlGeneratorPanel: React.FC = () => {
  ...
  const handleGenerate = async (): Promise<void> => {
    ...
    const request: GeneratePromptsRequest = {
      count: safeCount,
      type: 'monsterGirl', // Fixed type for monster girl
    ...
    console.log('Debug: MonsterGirl Request being sent:', request);
      ...
      <div className="card generator-panel">
        <div className="card__body">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-600 text-lg">Create captivating monster girl characters</p>
          </div>
          ...
          <form className="space-y-6" onSubmit={(event) => { event.preventDefault(); void handleGenerate(); }}>
            ...
            <div className="pt-4">
              <button
                className="w-full bg-gradient-mystic text-black py-4 px-8 rounded-xl font-bold text-lg
...
export default MonsterGirlGeneratorPanel;