...
const KemonominiGeneratorPanel: React.FC = () => {
  ...
  const handleGenerate = async (): Promise<void> => {
    ...
    const request: GeneratePromptsRequest = {
      count: safeCount,
      type: 'animalGirl', // Fixed type for kemonomimi
    ...
    console.log('Debug: Kemonomimi Request being sent:', request);
        ...
        <div className="card__body">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-slate-800 mb-4 flex items-center justify-center gap-3">
              ...
              Kemonomimi Generator
            </h2>
            <p className="text-slate-600 text-lg">Create adorable animal-eared characters</p>
          </div>
            ...
            <div className="pt-4">
              ...
              >
                ...
                <span className="relative flex items-center justify-center gap-3">
                  ...
                  {loading ? 'Generating...' : 'Generate Kemonomimi'}
                  <span className="text-xl">🐱</span>
                </span>
              </button>
            </div>
...
export default KemonominiGeneratorPanel;