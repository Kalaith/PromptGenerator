        ...
        <div className="min-h-screen bg-gradient-to-br from-white via-slate-50 to-violet-50 text-slate-900 font-sans">
          ...
          <main className="relative z-10">
            <Routes>
              ...
              <Route path="/description-templates" element={<ProtectedRoute><DescriptionTemplatesPage /></ProtectedRoute>} />
              <Route path="/attribute-manager" element={<ProtectedRoute><AttributeManagerPage /></ProtectedRoute>} />
              <Route path="/attribute-options" element={<ProtectedRoute><AttributeOptionsPage /></ProtectedRoute>} />
              <Route path="/generator-types" element={<ProtectedRoute><GeneratorTypeManagerPage /></ProtectedRoute>} />
